...
- Feedback API: functions return 4-char strings using `'G'` (green), `'Y'` (present), `'_'` (absent). See `compute_feedback` in [app.py](app.py) and `feedback` in [wordcube_game.py](wordcube_game.py).
